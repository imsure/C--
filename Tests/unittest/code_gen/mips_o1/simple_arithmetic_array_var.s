...
main:	la $sp, -8($sp) # Allocate space for old $fp and $ra
	...
	lw $10, -76($fp) # Load tmp address _taddr11.
	lb $9, ($10) # Load value of the char array element pointed by _taddr11.
	add $10, $8, $9
	...
	lw $10, -88($fp) # Load tmp address _taddr14.
	lw $9, ($10) # Load value of the int array element pointed by _taddr14.
	mul $10, $8, $9
	sw $10, -4($fp) # Store to tmp variable _tvar0.
	lw $8, -4($fp) # Load tmp variable _tvar0.
	sw $8, -8($fp) # Store to local int u.
	...
	lw $8, -8($fp) # Load local int u.
	lw $10, -92($fp) # Load tmp address _taddr15.
	lw $9, ($10) # Load value of the int array element pointed by _taddr15.
	div $10, $8, $9
	sw $10, -4($fp) # Store to tmp variable _tvar0.
	lw $8, -4($fp) # Load tmp variable _tvar0.
	sw $8, -8($fp) # Store to local int u.
	...
	lb $8, ($9) # Load value of the char array element pointed by _taddr16.
	lw $10, -100($fp) # Load tmp address _taddr17.
	lw $9, ($10) # Load value of the int array element pointed by _taddr17.
	sub $10, $8, $9
	sw $10, -4($fp) # Store to tmp variable _tvar0.
	lw $8, -4($fp) # Load tmp variable _tvar0.
	sw $8, -8($fp) # Store to local int u.
