...
_L6:	li $8, 0 # Load int constant shorter than 16-bits
	...
	.text
_L8:	add $10, $12, $13
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	li $8, 2 # Load int constant shorter than 16-bits
	move $11, $8 # Store local tmp _tvar4 to its pre-assigned register.
	div $10, $14, $11
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	move $11, $14 # Store local int b to its pre-assigned register.
	ble $11, $15, _L12
	.text
_L11:	add $10, $16, $11
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	move $16, $14 # Store local int res to its pre-assigned register.
	j _L13
	.text
_L12:	add $10, $16, $13
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
...
_L13:	li $8, 1 # Load int constant shorter than 16-bits
	...
	add $10, $12, $14
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	move $12, $14 # Store local int a to its pre-assigned register.
	.text
...
_L7:	li $8, 1 # Load int constant shorter than 16-bits
	...
	add $10, $15, $14
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	move $15, $14 # Store local int j to its pre-assigned register.
	.text
...
_L5:	li $8, 1 # Load int constant shorter than 16-bits
	...
	add $10, $17, $14
	move $14, $10 # Store local tmp _tvar3 to its pre-assigned register.
	move $17, $14 # Store local int i to its pre-assigned register.
	.text
