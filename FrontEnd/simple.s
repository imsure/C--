...
_L0:	li $8, 0 # Load int constant shorter than 16-bits
	...
	.text
_L3:	add $10, $17, $15
	move $14, $10 # Store local tmp _tvar2 to its pre-assigned register.
	li $8, 2 # Load int constant shorter than 16-bits
	move $11, $8 # Store local tmp _tvar3 to its pre-assigned register.
	div $10, $14, $11
	move $14, $10 # Store local tmp _tvar2 to its pre-assigned register.
	move $13, $14 # Store local int k to its pre-assigned register.
	ble $13, $17, _L7
	.text
_L6:	li $8, 0 # Load int constant shorter than 16-bits
	move $14, $8 # Store local tmp _tvar2 to its pre-assigned register.
